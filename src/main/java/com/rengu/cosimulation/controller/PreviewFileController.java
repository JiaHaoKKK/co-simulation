...
public class PreviewFileController {
    ...
    public String localFile(String subtaskFileId, Model model, HttpServletRequest request) throws IOException {
     ...
     */
    public String previewUrl(PreviewFileEntity PreviewFileEntity, Model model, HttpServletRequest request)
           {
